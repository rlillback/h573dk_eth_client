...
/**
 *  Enable the Legacy TLS Layer - but stay away from TLS1.3 as
 *  it has a significantly larger footprint and overhead.
 */
/* TLS and SSL configuration */
#define MBEDTLS_SSL_KEEP_LEGACY_STRUCT_LAYOUT
...
/* Entropy and RNG using STM32 TRNG */
...
/* We don't want to use the pre-release PSA APIs */
...
/* We need to temporarily remove this until we have a filesystem */
/* ### RAL */
#define MBEDTLS_X509_REMOVE_PARSE_PATH
